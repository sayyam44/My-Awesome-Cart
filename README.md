Developed a fully functional e-commerce website using Django framework, incorporating features such as user authentication, product catalog management, cart functionality, shipping, tracking etc.
